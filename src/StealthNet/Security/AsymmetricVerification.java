...
public class AsymmetricVerification {
	...
	/** {@link Key} used to create a signature. */
	protected PrivateKey signerKey;
	
	/** {@link Key} used to verify a signature. */
	...
	/**
	 * Set the signer {@link PrivateKey}. <p> This must be set before attempting
	 * to sign any data.
	 * 
	...
	/**
	 * Set the verifier {@link Key}. <p> This must be set before attempting to
	 * verify any data.
	 * 
	 ...
	 * @see Base64
	 */
	public boolean verify(final String message, final byte[] signature) throws InvalidKeyException, NoSuchAlgorithmException, SignatureException {
		if (verifierKey == null)
	 ...
	 * @see Base64
	 */
	public boolean verify(final byte[] message, final byte[] signature) throws NoSuchAlgorithmException, InvalidKeyException, SignatureException {
		if (verifierKey == null)
			throw new IllegalStateException("Cannot perform decryption without a verifier key.");
