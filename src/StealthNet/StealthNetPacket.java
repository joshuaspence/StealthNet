 ...
 *  and cannot be used again for future communications. The StealthNetPacket 
 *  class will allow packets to be created without a token (if a null 
 *  StealthNetPRNG instance is passed to the function). A higher layer should 
...
public class StealthNetPacket {
     ...
     */
    public StealthNetPacket(byte cmd, byte[] d, int dLen, StealthNetMAC mac, Long token) {
        this.command = cmd;
