...
symmetric cryptographic key. Asymmetric encryption/decryption is many times
slower than symmetric encryption/decryption, but this does not present any 
...
\subsection{Details}
\algorithm{AES} is based on a design principle known as a 
