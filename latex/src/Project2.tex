...
The final class stores the encrypt() and decrypt() functions that use the public and private keys used by the RSA algorithm, and also generates and distributes keys when necessary to users across the network.
